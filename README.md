...
3. Install NodeJS, then execute "run.sh" to ensure that node.js is working and, to make sure the script works.
  - (It should produce a "xmltv.tv" file in this diretory.)
5. Create a automatic service/cron entry to automatically start the run.sh script on a schedule.
  - (You may need to modify the run.sh script to your needs.)
> [!WARNING]
